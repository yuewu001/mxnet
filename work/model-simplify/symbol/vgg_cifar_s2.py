...
def get_symbol(num_classes):
    ...
    conv1_1 = mx.symbol.Convolution(data=data,
                                    ...
                                    pad=(1, 1),
                                    name="conv1_1")
    nw1_1 = mx.symbol.NeuronWeighting(data=conv1_1, order=2, name="nw1_1")
    ...
    conv1_2 = mx.symbol.Convolution(data=drop1_1,
                                    ...
                                    pad=(1, 1),
                                    name="conv1_2")
    nw1_2 = mx.symbol.NeuronWeighting(data=conv1_2, order=2, name="nw1_2")
    ...
    conv2_1 = mx.symbol.Convolution(data=pool1,
                                    ...
                                    pad=(1, 1),
                                    name="conv2_1")
    nw2_1 = mx.symbol.NeuronWeighting(data=conv2_1, order=2, name="nw2_1")
    ...
    conv2_2 = mx.symbol.Convolution(data=drop2_1,
                                    ...
                                    pad=(1, 1),
                                    name="conv2_2")
    nw2_2 = mx.symbol.NeuronWeighting(data=conv2_2, order=2, name="nw2_2")
    ...
    conv3_1 = mx.symbol.Convolution(data=pool2,
                                    ...
                                    pad=(1, 1),
                                    name="conv3_1")
    nw3_1 = mx.symbol.NeuronWeighting(data=conv3_1, order=2, name="nw3_1")
    ...
    conv3_2 = mx.symbol.Convolution(data=drop3_1,
                                    ...
                                    pad=(1, 1),
                                    name="conv3_2")
    nw3_2 = mx.symbol.NeuronWeighting(data=conv3_2, order=2, name="nw3_2")
    ...
    conv3_3 = mx.symbol.Convolution(data=drop3_2,
                                    ...
                                    pad=(1, 1),
                                    name="conv3_3")
    nw3_3 = mx.symbol.NeuronWeighting(data=conv3_3, order=2, name="nw3_3")
    ...
    conv4_1 = mx.symbol.Convolution(data=pool3,
                                    ...
                                    pad=(1, 1),
                                    name="conv4_1")
    nw4_1 = mx.symbol.NeuronWeighting(data=conv4_1, order=2, name="nw4_1")
    ...
    conv4_2 = mx.symbol.Convolution(data=drop4_1,
                                    ...
                                    pad=(1, 1),
                                    name="conv4_2")
    nw4_2 = mx.symbol.NeuronWeighting(data=conv4_2, order=2, name="nw4_2")
    ...
    conv4_3 = mx.symbol.Convolution(data=drop4_2,
                                    ...
                                    pad=(1, 1),
                                    name="conv4_3")
    nw4_3 = mx.symbol.NeuronWeighting(data=conv4_3, order=2, name="nw4_3")
    ...
    conv5_1 = mx.symbol.Convolution(data=pool4,
                                    ...
                                    pad=(1, 1),
                                    name="conv5_1")
    nw5_1 = mx.symbol.NeuronWeighting(data=conv5_1, order=2, name="nw5_1")
    ...
    conv5_2 = mx.symbol.Convolution(data=drop5_1,
                                    ...
                                    pad=(1, 1),
                                    name="conv5_2")
    nw5_2 = mx.symbol.NeuronWeighting(data=conv5_2, order=2, name="nw5_2")
    ...
    conv5_3 = mx.symbol.Convolution(data=drop5_2,
                                    ...
                                    pad=(1, 1),
                                    name="conv5_3")
    nw5_3 = mx.symbol.NeuronWeighting(data=conv5_3, order=2, name="nw5_3")
